...
function instructionsPage1(condition_number) {
    ...
    <h2>Instructions</h2>
    <p>
    In this study we are interested in how we can evaluate the morality of people's behavior in their social relationships.
    </p>
    <p>
...
function instructionsPage2() {
    ...
    <p>We will ask you to evaluate <strong>how moral</strong> the second interaction was.</p>
    <p>You will submit your answers on a seven-point scale, from 1 (morally forbidden) to 7 (morally obligatory).</p>
 `
}
